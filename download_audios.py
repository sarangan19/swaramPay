...
SERVICE_PROMPTS = {
    "hi": {
        ...
        "anything_else":    "Aur kuch jisme main aapki madad kar sakta hoon?",
    ...
    "ta": {
        ...
        "anything_else":    "Innum etheavathu ungalukku udhava mudiyuma?",
    ...
    "te": {
        ...
        "anything_else":    "Inka edainaa meeku sahayam cheyagalanaa?",
    ...
    "kn": {
        ...
        "anything_else":    "Innu yaavudaadaru sahaaya beku?",
    ...
    "ml": {
        ...
        "anything_else":    "Innum enthenkilum sahayam venamo?",
    ...
    "mr": {
        ...
        "anything_else":    "Aankhi kahi madat hawi aahe ka?",
    ...
    "bn": {
        ...
        "anything_else":    "Ar kichu ki apnar jonyo korte pari?",
    ...
    "gu": {
        ...
        "anything_else":    "Bijun kai madad joi che?",
...
STATIC_REGISTRATION_PROMPTS = {
    "hi": {
        ...
        "guardian_ask":      "Aapko ek SMS bheja gaya hai jisme companion portal ka link hai. Kya aap kisi guardian ko apne wallet mein paise daalne ki anumati dena chahte hain? Haan ya nahi boliye.",
        "guardian_number_ask": "Theek hai. Guardian ka 10 ank ka number abhi boliye.",
        ...
        "auth_retry":        "Maafi kijiye, aapki awaaz match nahi hui. Kripaya phir se koshish karein.",
    ...
    "en": {
        ...
        "guardian_ask":      "We have sent you an SMS with the companion portal link. Would you like to add a guardian who can add money to your wallet? Please say yes or no.",
        "guardian_number_ask": "Okay. Please say the guardian's 10-digit number now.",
        ...
        "auth_retry":        "Sorry, your voice didn't match. Please try again.",
    ...
    "ta": {
        ...
        "guardian_ask":      "Ungal SMS-il companion portal link anuppinoom. Wallet-il panam podra anumathi guardian-kku kodukka virumbukirirgala? Aam alladhu illai sollunga.",
        "guardian_number_ask": "Sari. Guardian number-ai ippo sollunga.",
        "guardian_dtmf":     "Guardian number keypad il type pannunga.",
        "auth_fail":         "Kural arival moonru murai thappu. Keypad PIN upayogippu.",
        "auth_retry":        "Sorry, ungal kural match aagavillai. Thayavu seidhu meendum try pannunga.",
    ...
    "te": {
        ...
        "guardian_ask":      "Mee SMS ki companion portal link pathimamu. Mee wallet ki dabbulu jamacheyataniki guardian ki anumati ivvalani anukuntunnara? Avunu leda kadu cheppandi.",
        "guardian_number_ask": "Sare. Ippudu guardian number cheppandi.",
        "guardian_dtmf":     "Keypad lo guardian number enter cheyyandi.",
        "auth_fail":         "Voice auth moodu saarlu fail. Keypad PIN vadakandi.",
        "auth_retry":        "Sorry, mee voice match avaledu. Dayachesi malli try cheyyandi.",
    ...
    "kn": {
        ...
        "guardian_ask":      "Companion portal link SMS madhye kalisiddeve. Nimma wallet ge hanu serpadeyalu guardian ge anumati needabeku ennistideera? Hoodu athva illa heli.",
        "guardian_number_ask": "Sari. Eega guardian number heli.",
        "guardian_dtmf":     "Keypad nadige guardian number enter madi.",
        "auth_fail":         "Voice auth moonru bari fail. Keypad PIN upayogisi.",
        "auth_retry":        "Sorry, nimma voice match aagalilla. Dayavittu matte try madi.",
    ...
    "ml": {
        ...
        "guardian_ask":      "Companion portal link SMS il anachchu. Ningalude wallet il panam churukkan guardian-inu anuvaadam nalkano? Athe allenkil alla parayoo.",
        "guardian_number_ask": "Sheri. Ippol guardian number parayoo.",
        "guardian_dtmf":     "Guardian number keypadil type cheyyoo.",
        "auth_fail":         "Voice auth moonnu thavana fail. Keypad PIN upayogikku.",
        "auth_retry":        "Sorry, ningalude voice match aayilla. Dayavayi veendum try cheyyuka.",
    ...
    "mr": {
        ...
        "guardian_ask":      "Companion portal link SMS madhye pathavala ahe. Tumchya wallet madhe paise jama karnyasathi guardian la parvani dyaychi ahe ka? Ho kiva nahi sanga.",
        "guardian_number_ask": "Theek ahe. Aata guardian cha number sanga.",
        "guardian_dtmf":     "Guardian number keypad var enter kara.",
        "auth_fail":         "Voice auth tin velaa fail. Keypad PIN vaapra.",
        "auth_retry":        "Sorry, tumcha voice match zhala nahi. Krupaya punha try kara.",
    ...
    "bn": {
        ...
        "guardian_ask":      "Companion portal link SMS e pathano hoyeche. Apnar wallet e taka jomar jonno guardian ke onumoti dite chan? Ha na bolun.",
        "guardian_number_ask": "Thik ache. Ekhon guardian er number bolun.",
        "guardian_dtmf":     "Keypad e guardian number din.",
        "auth_fail":         "Voice auth teen bar fail. Keypad PIN byabohar korun.",
        "auth_retry":        "Sorry, aapnar voice match hoyni. Doya kore abar try korun.",
    ...
    "gu": {
        ...
        "guardian_ask":      "Companion portal link SMS ma mokli chhe. Tamara wallet ma paisa umervani guardian ne parvangi aapva mango chho? Ha kena kaho.",
        "guardian_number_ask": "Saru. Have guardian no number kaho.",
        "guardian_dtmf":     "Keypad par guardian number nakhho.",
        "auth_fail":         "Voice auth tran vaar fail. Keypad PIN vaapo.",
        "auth_retry":        "Sorry, tamaro voice match thayo nathi. Krupa karine farithi try karo.",
